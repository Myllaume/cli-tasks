...
public class ProjectDb extends ProjectData {
  ...
  public static ProjectDb of(int id, String name, Instant createdAt, String fulltext) {
  ...
  public static ProjectDb fromSqlResult(java.sql.ResultSet sqlResult) throws java.sql.SQLException {
